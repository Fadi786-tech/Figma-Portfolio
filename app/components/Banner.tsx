...
export default function Banner(): React.JSX.Element {
  const texts = ["Software Engineer", "MERN Stack Developer", "Flutter Developer"];
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center pt-32 px-6"
    >
        ...
        <div className="flex flex-col lg:flex-row items-center ">
          ...
          <div className="flex justify-center lg:justify-end relative w-full lg:w-auto">
            <div className="relative top-10">
                ...
                <div className="relative inline-block ">
                  ...
                  <div className="relative">
                    <p className="text-white text-lg whitespace-nowrap">
                      Hello! I Am{" "}
                      <span className="text-purple-400">Fahad Sohail</span>
                    </p>
                  </div>
              ...
              <Image
                src="/assets/me.png"
                alt="Fahad Sohail - Software Engineer"
                width={300}
                height={300}
        ...
        <div className="space-y-3 pt-15 text-center lg:text-left">
          ...
          <p className="text-lg lg:text-xl text-white/90 tracking-wide flex flex-wrap items-center justify-center lg:justify-start gap-2">
            ...
            <span className="flex items-center gap-2">
              <a href="https://devgate.ca/"><img src="/logo/Logo-03(1).png" alt="DevGate" style={{ height: '40px', width: 'auto', maxWidth: '120px' }} /></a>
              {/* <span className="text-orange-400 font-semibold">DevGate,</span> */}
            </span>
          </p>
          <p className="text-lg text-white/80 max-w-2xl mt-15 mx-auto lg:mx-0">
            A self-taught Software Engineer, functioning in the industry for 1+
